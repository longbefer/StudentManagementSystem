				...
				<tr>
					...
					<td>
						 ...
						 <%
						 	...
						 	Teacher tecGet = new Teacher(Long.parseLong(teacher_id));
						 	tecGet.setTeacherInfo();
						 %>
						 	<input name="teacher_id" value="<%= tecGet.id%>" type="number" readonly="readonly" style="display: none;"/>
						 	<span><%= tecGet.name %></span>
